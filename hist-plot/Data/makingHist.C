...
TString path = "/eos/atlas/atlascerngroupdisk/phys-exotics/jdm/dibjet/FullRUN2/NewCleaningData/";
...
TString getInputPath(TString dateset, TString dataset0);
...
void makingHist(TString dataset, TString dataset0, TString intree){
  ...
  vector<int> *jet_clean_passLooseBad = 0;
